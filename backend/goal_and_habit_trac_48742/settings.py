"""
Django settings for goal_and_habit_trac_48742 project.
...
ROOT_URLCONF = 'goal_and_habit_trac_48742.urls'
...
WSGI_APPLICATION = 'goal_and_habit_trac_48742.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Goal and habit tracker Support <support@goal-and-habit-trac-48742.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "goal_and_habit_trac_48742 API",
    "DESCRIPTION": "API documentation for goal_and_habit_trac_48742 App",
    "VERSION": "v1",
}
